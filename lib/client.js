window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function measure(landmarks) {
			...
			const composerTop = (scrollport.querySelector("[data-composer-seat]") ?? document.querySelector("[data-composer-seat]"))?.getBoundingClientRect().top;
			const bottom = composerTop === void 0 ? viewport.bottom : Math.min(viewport.bottom, composerTop);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("nav", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [landmarks.map((landmark, index) => {
						...
						const proximity = focus === null ? void 0 : index === focus.index ? "selected" : Math.abs(index - focus.index) === 1 ? "neighbor" : void 0;
